#!/usr/bin/env bash
# kioku-setup.sh — One-command setup for Kioku Agent Kit
...
echo "  Copy CLAUDE.md to your project root — Claude will auto-discover it."
echo ""
